...
export interface PaginationData<T> {
  current_page: number;
  data: T; // This will be the actual array of items (e.g., Permission[])
 ...
 * that could contain pagination data.
 * @template T The type of data wrapped by the API response (e.g., PaginationData<Permission[]>).
 */
export interface ApiResponse<T> {
  status: boolean;
  message?: string; // Laravel can return a message here
  data: T; // This 'data' property holds the PaginationData structure
}
